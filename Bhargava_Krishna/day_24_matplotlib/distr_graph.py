...
'''
https://api.data.gov.in/resource/d76a86b1-6a2a-4ab3-9201-cb9f6bc61fa4?api-key=579b464db66ec23bdd000001cdd3946e44ce4aad7209ff7b23ac571b&format=json&offset=0&limit=10
'''
...
#plot the graph
df.plot(kind = "scatter", x = "totalnoofapplication", y = "districtname" , xlabel="no.of applications", ylabel="district")
plt.show()
