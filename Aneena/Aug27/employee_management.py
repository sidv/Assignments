...
UPDATE_EMPLOYEE_USERNAME_URL = "https://sidnodeapp.herokuapp.com/getalluser"
UPDATE_EMPLOYEE_EMAIL_URL ="https://sidnodeapp.herokuapp.com/getalluser"
...
def add_employee():
	...
	payload = {"employeeid":i,"name": n,"username":u,"email":e,"salary":s,"previous_company":p}
...
def display_employee():
        ...
        d = {"name":name}
        header = {"Content-Type": "application/json"}
        res = req.get(DISPLAY_EMPLOYEE_URL, data=json.dumps(d), headers = header)
        print(res.json())
