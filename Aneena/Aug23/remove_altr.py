#5program to  remove alternate index word from above string.
...
lst = string.split(" ")
remove_altr = [ x for x in lst if lst.index(x)%2 == 0]
print("....Removing alternate index word....") 
print(" ".join(remove_altr))
