#Write a program to find all the words from above string where 
#first letter of word is 'c' and last letter is 'r'
...
lst = string.split(" ")
lst_letter = [ i  for i in lst if i!= '' and i[0] == "c" and i[-1] == "r"]
print(" ".join(lst_letter))
